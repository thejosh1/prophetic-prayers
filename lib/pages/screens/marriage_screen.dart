...
class _MarriageScreenState extends State<MarriageScreen> {
  ...
  void iniState(){
    super.initState();
    ScriptureController.instance.readMarriageJson();
  }
  @override
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 20),
                  Text("Prophetic Prayers for Marriage",
                    style: TextStyle(
                  ...
                  children: [
                    SingleChildScrollView(
                      child: Container(
                          ...
                          child: FutureBuilder(
                              future: ScriptureController.instance.readMarriageJson(),
                              builder: (context, snapshot) {
                                if(snapshot.hasError) {
                                  return Center(child: Text("${snapshot.error}"));
                                } else if(snapshot.hasData){
                                  var _scriptures = snapshot.data as List<Marriage>;
  ...
  Widget buildScriptures(List<Marriage> scriptures) {
