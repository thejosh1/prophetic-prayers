...
class _LifeStyleScreenState extends State<LifeStyleScreen> {
  ...
  void iniState(){
    super.initState();
    ScriptureController.instance.readLifeStyleJson();
  }
  @override
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text("Prophetic Prayers for LifeStyle",
                    style: TextStyle(
                  ...
                  children: [
                    SingleChildScrollView(
                      child: Container(
                          ...
                          child: FutureBuilder(
                              future: ScriptureController.instance.readLifeStyleJson(),
                              builder: (context, snapshot) {
                                if(snapshot.hasError) {
                                  return Center(child: Text("${snapshot.error}"));
                                } else if(snapshot.hasData){
                                  var _scriptures = snapshot.data as List<LifeStyle>;
  ...
  Widget buildScriptures(List<LifeStyle> scriptures) {
