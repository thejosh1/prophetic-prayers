...
class _DisciplineScreenState extends State<DisciplineScreen> {
  ...
  void iniState(){
    super.initState();
    ScriptureController.instance.readDisciplineJson();
  }
  @override
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text("Prophetic Prayers For Discipline",
                    style: TextStyle(
                  ...
                  children: [
                    SingleChildScrollView(
                      child: Container(
                          ...
                          child: FutureBuilder(
                              future: ScriptureController.instance.readDisciplineJson(),
                              builder: (context, snapshot) {
                                if(snapshot.hasError) {
                                  return Center(child: Text("${snapshot.error}"));
                                } else if(snapshot.hasData){
                                  var _scriptures = snapshot.data as List<Discipline>;
  ...
  Widget buildScriptures(List<Discipline> scriptures) {
